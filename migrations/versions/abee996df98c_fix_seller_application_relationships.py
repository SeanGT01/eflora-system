"""Fix seller application relationships

Revision ID: abee996df98c
Revises: 
Create Date: 2026-02-21 10:48:57.707459
...
revision = 'abee996df98c'
down_revision = 'store_images_in_db'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('government_id_path', sa.String(length=500), nullable=True),
    ...
    with op.batch_alter_table('stores', schema=None) as batch_op:
        batch_op.add_column(sa.Column('seller_application_id', sa.Integer(), nullable=True))
        ...
        batch_op.create_foreign_key(None, 'seller_applications', ['seller_application_id'], ['id'])
...
def downgrade():
    ...
    with op.batch_alter_table('stores', schema=None) as batch_op:
        ...
        batch_op.drop_column('seller_application_id')
